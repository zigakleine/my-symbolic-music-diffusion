...
flags.DEFINE_string('input',"./lakh_tfrecords/notesequences_redux.tfrecord", 'Path to tfrecord files.')
flags.DEFINE_string('output', "./out/outputs.tfrecord", 'Output path.')
